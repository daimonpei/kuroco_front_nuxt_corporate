  ...
  <div>
    <section class="c-hero">
      ...
      <div class="c-hero__background">
        <img
          ...
          alt="cloud"
          class="c-hero__background__image cloud1"
        />
        <img
          src="~/assets/image/cloud2.png"
          alt="cloud"
          class="c-hero__background__image cloud2"
        />
      </div>
    </section>
    ...
    <section class="c-section">
      <div class="l-container--large">
        ...
        >
          ...
          <div
            class="c-section--dark-block-price u-display-flex-grow-1 u-display-flex-shrink-1"
          >
            <b class="p1">@</b>
            <b class="p2">30</b>
            <b class="p3">円</b>
    ...
    <section class="l-container--contents c-section--bg">
      <div class="l-container--large">
        ...
        <div
          class="u-display-flex u-display-flex-align-items-center u-display-flex-justify-content-center u-mb-20"
        >
          <div class="u-display-flex-shrink-0">
            <NuxtLink to="/visions/" class="c-button">もっと見る</NuxtLink>
          </div>
        </div>
      </div>
    </section>
